...
if raw_allowed_hosts:
    ...
    # Restrictive default suitable for local development; production should set ALLOWED_HOSTS explicitly
...
if raw_allowed_origins:
    ...
    # Safe defaults for local development; production should set ALLOWED_ORIGINS explicitly
    allowed_origins = ["http://localhost:3000", "http://localhost:8000"]

app.add_middleware(
    CORSMiddleware,
    allow_origins=allowed_origins,
    allow_credentials=False,  # Set to True if you need cookies/auth headers, but restrict origins
    allow_methods=["*"],
    allow_headers=["*"],
)
...
async def update_user(
    user_id: str, update: UserUpdate, current_user: str = Depends(get_current_user)
):
